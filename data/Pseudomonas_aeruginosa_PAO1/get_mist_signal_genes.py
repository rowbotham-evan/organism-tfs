"""Download the MiST4 DNA-binding signal genes for P. aeruginosa PAO1.
...
set shown at mistdb.com/mist/genomes/GCF_000006765.1/signal-genes
...
GENOME_VERSION = "GCF_000006765.1"
TAXON_ID = 208964
KIND = "output"
...
OUTPUT = (
    ...
    / "data"
    / "pseudomonas_aeruginosa_pao1_mist_dna_binding_genes.csv"
)
    ...
    while True:
        response = session.get(
            ...
            params={
                "kind": KIND,
                "function": FUNCTION,
                "fields.Gene": "locus,old_locus,product",
                "per_page": PAGE_SIZE,
                "page": page,
            },
            timeout=120,
